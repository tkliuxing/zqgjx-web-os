...
<!--&lt;!&ndash;          }" clearable :show-all-levels="false"></el-cascader>&ndash;&gt;-->
...
<!--      </el-form-item>-->
      <el-form-item label="名称" style="margin-left: 35px">
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      ...
      let res = await resource.getObj("formdatareport", "5849", {
    ...
    ShuoMingTo() {
      this.$router.push({ name: "wplymx-shuoming" });
    },
    moment,
  },
  created() {
