<template>
  <div style="position:relative">
    ...
    <el-table :data="data.slice((page-1)*pageSize,page*pageSize)" border stripe :cell-style="{textAlign:'center'}" :header-cell-style="{textAlign:'center'}" @selection-change="(data) => (batchDelData = data)" v-loading="loading" element-loading-text="导入中...">
      ...
      <el-table-column label="借出单号" prop="jiechu_danhao"></el-table-column>
      <el-table-column label="档案名称" prop="name"></el-table-column>
      <el-table-column label="借出部门" prop="jiechu_bumen"></el-table-column>
      <el-table-column label="借出人员" prop="jiechu_ren"></el-table-column>
      <el-table-column label="联系方式" prop="lianxi_fangshi"></el-table-column>
