<template>
  <div style="position:relative">
    ...
    <el-table :data="data.slice((page-1)*pageSize,page*pageSize)" border stripe :cell-style="{textAlign:'center'}" :header-cell-style="{textAlign:'center'}" @selection-change="(data) => (batchDelData = data)" v-loading="loading" element-loading-text="导入中...">
      ...
      <el-table-column label="文档id" prop="wendang_id"></el-table-column>
      <el-table-column label="档案名称" prop="dangan_name"></el-table-column>
      <el-table-column label="转入单位" prop="zhuanrudanwei"></el-table-column>
      <el-table-column label="转入人员" prop="zhunrurny"></el-table-column>
      <el-table-column label="经办人员" prop="jiangban_userjiangban_user"></el-table-column>
...
export default {
  ...
  data() {
    ...
    excelTmp: {
       ...
       "转入单位": "zhuanrudanwei",
       "转入人员": "zhunrurny",
       "经办人员": "jiangban_userjiangban_user",
       "存放地点": "cunfang",
       "备注": "beizhu",
