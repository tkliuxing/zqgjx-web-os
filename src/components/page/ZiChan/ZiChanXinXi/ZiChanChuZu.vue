  ...
  <div>
    ...
    >
      <el-form label-width="auto" ref="form" :model="form" :rules="rules">
        <el-form-item label="租借单位" prop="to_department">
         <el-input v-model="form.to_department"></el-input>
        </el-form-item>
        <el-form-item label="租借联系人" prop="to_person">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        to_department: [{ required: true, message: "请填写出租单位" }],
        to_person: [{ required: true, message: "请填写租借联系人" }],
