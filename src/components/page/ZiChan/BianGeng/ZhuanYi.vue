<template>
  <el-card>
    ...
    >
      <el-table-column label="转移单号" prop="pk" width="130px"></el-table-column>
      <el-table-column label="资产名称" prop="zichan_name"></el-table-column>
      <el-table-column label="资产编号" prop="zichan_sn"></el-table-column>
      <el-table-column label="转出部门" prop="out_department_display"></el-table-column>
      <el-table-column label="转入部门" prop="to_department_display"></el-table-column>
      <el-table-column label="转移人员" prop="to_person"></el-table-column>
      <el-table-column label="经办人员" prop="hanlder_person"></el-table-column>
      <el-table-column label="存放地点" prop="to_address"></el-table-column>
      <el-table-column label="转移时间" prop="create_time"></el-table-column>
  ...
  methods: {
    ...
    download() {
      let headers = [
        ...
        { 资产名称: "zichan_name" },
        { 资产编号: "zichan_sn" },
        { 转移部门: "to_department_display" },
        { 转移人员: "to_person" },
        { 经办人员: "hanlder_person" },
        { 转移时间: "create_time" },
        { 备注: "remark" },
      ];
      xlsxExcel(headers, "固定资产转移记录", this.data);
    },
  },
  created() {
    // this.loadData();
