<template>
  <el-card>
    ...
    >
      <el-table-column label="出租单号" prop="pk" width="130px"></el-table-column>
      ...
      <el-table-column label="租借单位" prop="to_department"></el-table-column>
      <el-table-column label="租借联系人" prop="to_person"></el-table-column>
      <el-table-column label="联系方式" prop="to_mobile"></el-table-column>
      <el-table-column label="经办人员" prop="hanlder_person"></el-table-column>
      <el-table-column label="出租时间" prop="create_time"></el-table-column>
      <el-table-column label="收回时间" prop="return_time">
      ...
      <el-table-column label="租借说明" prop="remark"></el-table-column>
  ...
  methods: {
    ...
    async loadData() {
      ...
      let params = {
        ...
        template_id: "FT301604609786073088",
      };
    ...
    download() {
      ...
      xlsxExcel(headers, "固定资产出租记录", this.data);
    },
  },
  created() {
    // this.loadData();
