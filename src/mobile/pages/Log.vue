      ...
      <div class="from">
        <van-form>
          <div class="log-from">
            <div class="from-title">
              <span class="from-icon"
                ><img src="@/mobile/assets/img/log/phone.png" alt=""
              /></span>
          ...
          <div class="log-from">
            <div class="from-title">
              <span class="from-icon"
                ><img src="@/mobile/assets/img/log/mima.png" alt=""
              /></span>
      ...
      <div class="from">
        <van-form>
          <div class="log-from">
            <div class="from-title">
              <span class="from-icon"
                ><img src="@/mobile/assets/img/log/user.png" alt=""
              /></span>
          ...
          <div class="log-from">
            <div class="from-title">
              <span class="from-icon"
                ><img src="@/mobile/assets/img/log/number.png" alt=""
              /></span>
          ...
          <div class="log-from">
            <div class="from-title">
              <span class="from-icon"
                ><img src="@/mobile/assets/img/log/bumen.png" alt=""
              /></span>
      ...
      try {
       ...
       this.$store.commit("LOGIN", login.token);
        ...
        if (e.response.data.non_field_errors) {
          ...
          Toast.fail(e.response.data.password[0]);
          return;
        }
      }
